...
setosa.train <- split.setosa$train
setosa.test <- split.setosa$test

split.versicolor <- train.test.split(versicolor)
versicolor.train <- split.versicolor$train
versicolor.test <- split.versicolor$test

training.data <- rbind(setosa.train, versicolor.train)
test.data <- rbind(setosa.test, versicolor.test)
```
